...
cards.innerHTML+=
`<div class="card"><div class="image"><img src="${thumbnail}" alt=""></div>
<div class="box"><p>${category}</p><h3>${title}</h3><p class="des">${description}</p><p class="sal">${price}$</p><a href="#">Add To Cart</a></div></div>`;
}
var mainData = [];
